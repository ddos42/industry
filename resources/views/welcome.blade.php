...
@section('content')
<main class="container blog_feed site_content">
   <div class="row">
       <div class="col-md-12">
  ...
  @foreach($slider_items as $key => $slider_item)
    <div class="item {{ $key == 0 ? 'active' : '' }}">
     <a href="{{$slider_item->id}}/slide_post"> <img src="{{ $slider_item->image_path }}" alt="{{ $slider_item->slide_title }} image"></a>
...
@foreach($blog_items as $blog_item)
            <div class="row blog_item">
                   <div class="col-md-4">
                       <div class="blog_item_thumbnail"><a href="{{ $blog_item->id }}/blog_post"><img src="{{ $blog_item->image_path }}" alt="{{ $blog_item->title }}"></a></div></div>
                    <div class="col-md-4">
